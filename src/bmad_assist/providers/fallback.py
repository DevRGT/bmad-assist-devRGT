        ...
        for i, fallback in enumerate(self.fallbacks):
            try:
                ...
                if not self._is_transient(e):
                    ...
                    # For fallbacks, maybe we should continue even on permanent errors?
                    # But usually permanent error means invalid request.
                    # Let's assume we continue to try finding a working one.
                    last_error = e
                    continue
